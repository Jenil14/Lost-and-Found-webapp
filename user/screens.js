...
function loadscreenEnd() {
  ...
  xhr.addEventListener("load", function() {
    if (xhr.status == 200) {
      ...
      for (let i = 0; i < rowCount; i++) {
        ...
        date2.innerHTML = listOfItems[i].date + " " + listOfItems[i].time;
  ...
  if (editscreen9) {
    editscreen9.addEventListener("click", function(e) {
      window.location.href = "/user/screen8.html";
    });
  }
  ...
  if (editscreen10) {
    editscreen10.addEventListener("click", function(e) {
      window.location.href = "/user/screen5.html";
    });
  }
}
...
function addItem(lostFound) {
  ...
  if (lostFound === "Found") {
    location.href = "https://spiral-north-plough.glitch.me/user/screen4.html";
  } else {
    location.href = "https://spiral-north-plough.glitch.me/user/screen7.html";
  }
}
...
function searchItem(lostFound) {
  ...
  if (lostFound === "Found") {
    location.href = "https://spiral-north-plough.glitch.me/user/screen10.html";
  } else {
    location.href = "https://spiral-north-plough.glitch.me/user/screen9.html";
  }
}
...
function loadscreen2() {
  ...
  finder[0].addEventListener("click", function(e) {
    console.log("Hello");
    window.location.href = "/user/screen3.html";
  });

  let seeker = document.getElementsByClassName("seeker");
  seeker[0].addEventListener("click", function(e) {
    console.log("Hello");
    window.location.href = "/user/screen6.html";
  });
}

function imageRedirect() {
  window.location.href = "/user/screen2.html";
}
